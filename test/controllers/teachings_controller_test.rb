...
class TeachingsControllerTest < ActionController::TestCase
  ...
  test "should create teaching" do
    assert_difference('Teaching.count') do
      post :create, teaching: { body: @teaching.body, summary: @teaching.summary, teaching_name: @teaching.teaching_name, user_id: @teaching.user_id }
    end
  ...
  test "should update teaching" do
    patch :update, id: @teaching, teaching: { body: @teaching.body, summary: @teaching.summary, teaching_name: @teaching.teaching_name, user_id: @teaching.user_id }
    assert_redirected_to teaching_path(assigns(:teaching))
  end
